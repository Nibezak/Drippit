 <nav class="px-4 flex py-2 text-sm justify-between block sm:hidden block md:hidden bg-blue-800 font-semibold text-white"  style="  position: -webkit-sticky; /* Safari */
  position: sticky;
  top: 0;">
                          <a href="{{ route('home') }}" class="text-blue-400">
                ...
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l9-9 9 9M5 10v10a1 1 0 001 1h3a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1h3a1 1 0 001-1V10M9 21h6"/>
                         ...
                         <a href="{{ route('profile', auth()->user()) }}" class="text-blue-400">
                          ...
                          <nav class="px-4 flex py-2 text-sm justify-between block  md:hidden hidden sm:block bg-blue-800 font-semibold text-white"  style="  position: -webkit-sticky; /* Safari */
  position: sticky;
  top: 0;">
  <center>
                          <a href="{{ route('home') }}" class="text-blue-400 inline-flex">
                             <svg class="mr-4 h-6 w-6 " stroke="currentColor" fill="none" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l9-9 9 9M5 10v10a1 1 0 001 1h3a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1h3a1 1 0 001-1V10M9 21h6"/>
              </svg>
                         </a>
                         <a href="#" class="text-blue-400 inline-flex">
                               <svg class="mr-4 h-6 w-6" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" stroke="currentColor" viewBox="0 0 24 24"><path d="M7 20l4-16m2 16l4-16M6 9h14M4 15h14"></path></svg>
                             </a>
                           <a href="#" class="text-blue-400 inline-flex">
                         ...
                         <a href="{{ route('profile', auth()->user()) }}" class="text-blue-400 inline-flex">
                             <svg class="mr-4 h-6 w-6" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" stroke="currentColor" viewBox="0 0 24 24"><path d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path></svg>
                         </a>
                           <a href="#" class="text-blue-400 inline-flex">
